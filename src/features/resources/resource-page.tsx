...
const configs: Record<string, ResourceConfig> = {
  ...
  medicines: { resource: 'medicines', title: 'Medicines', description: 'Maintain the canonical medicine and category catalogue.', singular: 'medicine', statuses: ['ACTIVE', 'INACTIVE', 'PRESCRIPTION_REQUIRED'], action: { label: 'Deactivate', nextStatus: 'INACTIVE' }, columns: [{ key: 'name', label: 'Medicine' }, { key: 'genericName', label: 'Generic name' }, { key: 'brand', label: 'Brand' }, { key: 'strength', label: 'Strength' }, { key: 'form', label: 'Form' }, { key: 'requiresPrescription', label: 'Prescription' }, { key: 'status', label: 'Status', format: 'status' }] },
